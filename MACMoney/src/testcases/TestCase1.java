...
public class TestCase1 {
	...
	public static void main(String[] args) throws Exception {
		...
		// Create transaction sending 200$MAC from the lender to userA
		Transaction transaction = new Transaction(lender.getPublicKey(), userA.getPublicKey(), 200); 
		
		transaction.generateSignature(lender.getPrivateKey());// Generate transaction signature to be verified by the
															  // peers
